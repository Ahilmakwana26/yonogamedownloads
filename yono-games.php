...
?>
    <section class="hero">
        <div class="container">
            <h1>Explore All Games</h1>
            <p>Browse our complete collection of Yono games, rummy, teen patti, and other premium gaming apps. Filter by category and find your favorite games with all details and download links.</p>
        </div>
    </section>
